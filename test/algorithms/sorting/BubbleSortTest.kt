...
import challenges.algorithms.sorting.bubbleSort
...
class BubbleSortTest {
    ...
    @Test
    fun `bubbleSort works for already sorted array`() {
    ...
    @Test
    fun `bubbleSort works on arrays with repeated numbers`() {
